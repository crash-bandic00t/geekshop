...
urlpatterns = [
    ...
    path('categories/<int:id>/edit', views.EditCategoryView.as_view(), name='edit-category'),
    path('categories/<int:id>/delete', views.DeleteCategoryView.as_view(), name='delete-category'),

    path('products/', views.ProductsView.as_view(), name='products'),
    path('products/add', views.AddProductView.as_view(), name='add-product'),
    path('products/<int:id>/edit', views.EditProductView.as_view(), name='edit-product'),
    path('products/<int:id>/delete', views.DeleteProductView.as_view(), name='delete-product'),
